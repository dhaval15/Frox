...
local b_color = colors.luminent1 .. "00"
...
theme.wibar_bg = colors.yellow_dark .. "00"--theme.xcolor0 .. "00"
--theme.wibar_opacity = 0.7
theme.wibar_border_color = colors.red_dark
...
theme.sidebar_bg =  colors.background--theme.xbackground
theme.sidebar_bg_alt = "#FFFFFF"--theme.xcolor0
theme.sidebar_fg = colors.text --theme.xcolor7
...
theme.hotkeys_label_bg = colors.transperent
theme.hotkeys_border_color = colors.luminent1
theme.hotkeys_border_width = dpi(1)


-- Start Screen

theme.start_background = ""
...
theme.volume_bar_color = colors.blue_dark
theme.volume_bar_color_muted = colors.blue_dark .. "50"
